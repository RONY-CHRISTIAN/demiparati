...
const mensaje = [
"Desde el primer momento en que nuestras palabras se encontraron, sentí una conexión única y especial. Cada conversación que hemos compartido ha revelado lo extraordinaria que eres. Aunque aún no hemos tenido la oportunidad de vernos en persona, mi corazón siente como si te conociera de toda la vida. Te amo mucho Zaida. <3"
];
...
function generarEmoticones() {
    ...
    //const emojis = ["❤️", "💖", "💘", "💌", "💕", "😍", "🥰"];
    const emojis = ["❤️", "💖", "💘", "💝", "💌", "💕", "💓", "💗","DESARROLLADO POR EPSILON", "😘", "😚", "😙", "🥰", "💞", "💕", "💓"];
